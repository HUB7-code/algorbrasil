...
## 5. Próximos Passos (To-Do List)
- [x] **Página de Login:** Implementar visual e conexão. (FEITO)
- [x] **Página de Associação:** Criar landing page de conversão. (FEITO)
- [x] **Dashboard:** Criar área logada. (FEITO)
- [ ] **Testes:** validar fluxo de Login com usuário real no banco.
- [ ] **Docker:** Criar `Dockerfile` e `docker-compose.yml` para facilitar deploy.
- [ ] **VPS:** Contratar e subir a aplicação via Docker.
