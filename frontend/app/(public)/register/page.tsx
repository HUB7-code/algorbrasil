...
const activePersona = role && personaImages[role] ? personaImages[role] : null;
...
return (
    <main className="min-h-screen w-full flex flex-col md:flex-row bg-gradient-to-br from-aurora-bg-gradient-start to-aurora-bg-gradient-end text-gray-100 font-sans selection:bg-aurora-violet selection:text-white">
        {/* ... content checks role which is initially null then updates ... */}
        {/* ... copy existing JSX ... */}
            ...
            {activePersona && (
                <div className="relative z-10 flex-grow flex items-center justify-center py-8 animate-in fade-in zoom-in duration-1000 perspective-1000">
                    <div className="relative w-full max-w-[420px] aspect-square group cursor-default">
                        ...
                        <div className="relative w-full h-full rounded-[32px] overflow-hidden border border-white/10 bg-[#0F172A]/50 backdrop-blur-sm shadow-2xl transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] group-hover:border-white/20">
