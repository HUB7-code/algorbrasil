    ...
    return (
        <div className="animate-in fade-in duration-700">
            ...
            <div className="bg-[#0A0A15] border border-slate-800 rounded-2xl p-8 mb-12">
                <h3 className="flex items-center gap-2 text-[#4F7EFF] mt-0">
                ...
                <div className="flex items-center gap-4 text-slate-200 bg-slate-900/50 p-4 rounded-lg border border-slate-800/50">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4F7EFF] to-blue-800 flex items-center justify-center font-bold text-lg">
                        L
                    </div>
                    <div>
                ...
                <form onSubmit={handleSubmit} className="bg-[#0A0A15] border border-slate-800 rounded-xl p-6 md:p-8 space-y-6 not-prose">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input type="text" required className="w-full bg-[#0E121F] border border-slate-800 focus:border-[#4F7EFF] rounded-xl px-4 py-3.5 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-[#4F7EFF]/50 transition-all font-sans" placeholder="Ex: João da Silva" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm text-slate-300 font-medium">E-mail Corporativo</label>
                            <input type="email" required className="w-full bg-[#0E121F] border border-slate-800 focus:border-[#4F7EFF] rounded-xl px-4 py-3.5 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-[#4F7EFF]/50 transition-all font-sans" placeholder="nome@empresa.com.br" />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <select className="w-full bg-[#0E121F] border border-slate-800 focus:border-[#4F7EFF] rounded-xl px-4 py-3.5 text-white focus:outline-none focus:ring-1 focus:ring-[#4F7EFF]/50 transition-all appearance-none font-sans">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea className="w-full bg-[#0E121F] border border-slate-800 focus:border-[#4F7EFF] rounded-xl px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-[#4F7EFF]/50 transition-all min-h-[140px] font-sans" placeholder="Por favor, descreva sua solicitação com detalhes para agilizarmos o atendimento..."></textarea>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full bg-[#4F7EFF] hover:bg-[#0088D4] text-white font-medium py-3 rounded-lg flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_4px_14px_rgba(79,126,255,0.3)]"
                    >
                        {status === "submitting" ? (
