                    ...
                    <aside className="lg:col-span-1 space-y-8">
                        <div className="flex flex-col gap-6 sticky top-40">
                            ...
                            <div className="p-5 rounded-2xl bg-[#0B0F1E] border border-white/5 mt-8 relative overflow-hidden group">
                                ...
                                <div className="text-[10px] font-mono text-[#4F7EFF] bg-[#4F7EFF]/5 border border-[#4F7EFF]/20 px-2 py-1 rounded inline-block relative z-10">
                                    ● v1.0.2 (Auditada)
                                </div>
                            </div>
                    ...
                    <main className="lg:col-span-3 pb-24 relative">
                        ...
                        <div className="fixed bottom-8 right-8 flex flex-col gap-3 z-50 no-print">
                            ...
                            <button
                                ...
                                className="bg-[#0B0F1E] hover:bg-[#4F7EFF] text-slate-400 hover:text-black p-3 rounded-full border border-slate-700 hover:border-[#4F7EFF] transition-all shadow-lg group"
                        ...
                        <div className="mt-16 pt-8 border-t border-slate-800 text-sm text-slate-500 font-mono no-print">
                            <div className="flex flex-col md:flex-row justify-between gap-4">
                                ...
                                <div className="text-right">
                                    <p>Hash SHA-256: <span className="text-[#4F7EFF]">e3b0c442...</span> (Validado)</p>
                                </div>
                            </div>
                        </div>
                    </main>
